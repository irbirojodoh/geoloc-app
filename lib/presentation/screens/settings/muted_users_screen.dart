          ...
          slivers: [
            ...
            muted.when(
                ...
                if (users.isEmpty) {
                  return const SliverFillRemaining(
                    ...
                    child: EmptyState(
                      ...
                      message: 'People you mute will appear here.',
                    ),
                  );
                }
                          ...
                          child: Padding(
                            ...
                            child: Row(
                              children: [
                                ...
                                TextButton(
                                  onPressed: () =>
                                      _confirmUnmute(context, ref, u.id),
              ...
              error: (e, _) => SliverFillRemaining(
                ...
                child: ErrorState(
                  message: '$e',
                  onRetry: () => ref.invalidate(mutedUsersListProvider),
                  retryLabel: 'Retry',
                ),
              ),
            ),
  ...
  Future<void> _confirmUnmute(
    ...
    final ok = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        title: Text('Unmute user?', style: context.textTheme.headlineSmall),
        content: Text(
